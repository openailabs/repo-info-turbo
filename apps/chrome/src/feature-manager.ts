...
const setupPageLoad = async (id: string, config: InternalRunConfig): Promise<void> => {
...
const getFeatureID = (url: string): string => {
    // console.log(`URL: ${url}`)
    ...
    return `${prefix}${name}` as string
}

/** Register a new feature */
const add = async (id: string, ...loaders: FeatureLoader[]): Promise<void> => {
