        ...
        >
          ...
          <p className="text-sm font-semibold text-sky-500">
            Introducing Acme Corp
                ...
                >
                    <Balancer>
                        Acme Corp is a Next.js starter kit that includes
                        everything you need to build a modern web application.
                        Mobile application preconfigured, ready to go.
                    </Balancer>
                </p>
                <div
            ...
            <div className="my-16 w-full max-w-screen-lg animate-fade-up gap-5 border-t p-5 xl:px-0">
                ...
                <p className="pb-8 pt-4 text-center text-lg">
                    <Balancer>
                        This repo comes fully stacked with everything you need
                        for your enterprise startup. Stop worrying about
                        boilerplate integrations and start building your product
                        today!
                    </Balancer>
                </p>
